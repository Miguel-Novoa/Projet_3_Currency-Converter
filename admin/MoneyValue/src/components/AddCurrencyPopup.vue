    ...
    <v-dialog v-model="dialog" max-width="600">
      <v-card class="card">
        ...
        <v-card-text class="cardContent">
          <v-text-field variant="solo" v-model="code" label="Code" type="text" :rules="codeRules" maxlength="3"
            class="inputs"></v-text-field>

          <v-textarea variant="solo" v-model="description" label="Description" :rules="descriptionRules" maxlength="50"
            class="inputs"></v-textarea>
